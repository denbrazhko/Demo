...
//        this.apikey = Key.key().getPublicKey();
//        this.secret = Key.key().getPrivateKey();
...
//        String content="";
//        String signature="";
//        String contentHash = com.rexbot.bot.api.SHA512.get_SHA_512_SecurePassword(content);
...
//           // byte temp[] =
//           // String reshex = new String(temp, StandardCharsets.UTF_8);
//           // char[] chars = reshex.toLowerCase().toCharArray();
//            signature = new String(org.apache.commons.codec.binary.Hex.encodeHex(sha_HMAC.doFinal(preSign.getBytes())));
//        }
//        catch (Exception e){
